...
filename = 'Diffraction_Data_6061_F.txt';
...
%original d spacing
d0 = 1.2181161; %Angstroms
d0err = (8e-6/d0)*100;

%Soring data into seperate arrays
for i=1:length(A)
...
title('6061-T6 Axial & Transverse Strain')
xlabel('Deformation')
ylabel('Position along the sample [mm]')
ax = gca;
ax.XAxis.Exponent = -3;
...
title('6061-T6 Residual Elastic Stress Graph')
xlabel('Stress [Pa]')
ylabel('Position along the sample [mm]')
xlim ([-200e6 200e6])
ax = gca;
